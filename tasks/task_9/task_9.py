...
class QuizManager:
    ...
    def next_question_index(self, direction=1):
        ...
        """
        ##### YOUR CODE HERE #####
        if not st.session_state["question_index"]:
            raise AttributeError("st.session_state['question_index'] is missing")
        ...
        with st.container():
            ...
            with st.form("Multiple Choice Question"):
                ...
                answer = st.radio(  # Display the radio button with the choices
                    "Choose the correct answer", choices, index=None
                )
