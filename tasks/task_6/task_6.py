...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        embeddings_client = EmbeddingClient(embed_config["model_name"], embed_config["project"], embed_config["location"])

        # 3) Initialize the ChromaCollectionCreator from Task 5
        chroma_creator = ChromaCollectionCreator(doc_processor, embeddings_client)
        ...
        with st.form("Load Data to Chroma"):
            ...
            num_qs = st.slider("number of questions", max_value=15)
            ...
            if submitted:
                ...
                print(f"chroma: {chroma_creator.db._collection.get()}")
